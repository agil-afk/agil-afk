...
<head>
  ...
  <title>Portofolio Agil</title>
  <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center">

  <div class="text-center space-y-6">
    <div class="text-6xl text-cyan-400 animate-pulse">
      <span>&lt;/&gt;</span>
    </div>

    <h1 class="text-xl font-bold">Laravel Enthusiast & Web Developer | Polytechnic Student</h1>

    <div class="flex flex-col items-center space-y-2">
      <div class="overflow-hidden rounded-full border-4 border-cyan-400 w-40 h-40 shadow-lg transform transition-transform duration-500 hover:scale-110 hover:rotate-3">
        <img src="35b945e1-e292-4a83-81fe-f06ba471ea02.png" alt="Foto Agil" class="w-full h-full object-cover" />
      </div>
      <p class="text-lg font-medium">Mohamad Agil Saputra Kantu</p>
    </div>
  </div>
